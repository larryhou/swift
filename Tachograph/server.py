...
class CameraProtocol(protocol.Protocol):
    ...
    def dataReceived(self, message):
        ...
        elif command == CameraCommand.SYSTEM:
        ...
        elif command == CameraCommand.FETCH_FOLDERS:
        ...
        elif command == CameraCommand.FETCH_ROUTE_VIDEO_LIST:
        ...
        elif command == CameraCommand.FETCH_EVENT_VIDEO_LIST:
        ...
        elif command == CameraCommand.FETCH_IMAGE_LIST:
        ...
        elif command == CameraCommand.CAPTURE_IMAGE:
            response = '{ "rval": 0, "msg_id": 769 }'
        else:
